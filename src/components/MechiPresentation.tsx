...
export function ImagePlaceholder({ 
  ...
  if (src) {
    return (
      <div className={`relative rounded-3xl overflow-hidden shadow-xl border border-stone-200/55 bg-white group hover:shadow-2xl transition-all duration-300 ${className}`}>
    ...
    <div className="w-full bg-white rounded-3xl overflow-hidden shadow-2xl border border-stone-200/60 text-stone-900 font-sans flex flex-col min-h-[450px]">
      ...
      <div className="border-b border-stone-100 px-4 py-3.5 flex items-center justify-between select-none bg-white">
        <div className="flex items-center gap-1.5 group cursor-pointer">
          ...
          <span className="font-display font-extrabold text-sm tracking-tight text-orange-600">Mechi</span>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="w-6 h-6 rounded-full bg-stone-150/60 flex items-center justify-center text-stone-400 shrink-0">
            <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
          </div>
        </div>
      </div>
            ...
            <div className="bg-white border border-stone-200/50 p-5 rounded-2xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shadow-sm">
              <div>
                <h3 className="text-lg sm:text-xl font-extrabold text-stone-900 flex items-center gap-2">
                  Сайн байна уу, naranbadrakh! <span className="inline-block animate-bounce select-none">👋</span>
                </h3>
              ...
              <div className="flex flex-col gap-1 items-start sm:items-end self-stretch sm:self-center shrink-0 border-t sm:border-t-0 border-stone-100 pt-3 sm:pt-0">
                <span className="text-[9px] uppercase font-mono tracking-wider text-stone-400">Өдөр тутмын явц</span>
                <div className="flex gap-1 mt-1 font-mono">
                  {[1, 2, 3, 4, 5].map((dayNum) => (
                    <span key={dayNum} className="w-5 h-5 rounded bg-orange-50 text-orange-600 text-[10px] font-bold flex items-center justify-center">
                      {dayNum}
                    </span>
                  ))}
              ...
              <div className="bg-white border border-stone-200/50 p-4.5 rounded-xl flex flex-col justify-between shadow-2xs">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-xs sm:text-sm font-extrabold text-stone-850">Үгийн сан</h4>
                  </div>
              ...
              <div className="bg-white border border-stone-200/50 p-4.5 rounded-xl flex flex-col justify-between shadow-box">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h4 className="text-xs sm:text-sm font-extrabold text-stone-850">Хэл зүй</h4>
                  </div>
                  <p className="text-[11px] text-stone-500 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white border border-stone-200/55 p-3.5 rounded-xl flex items-center justify-between shadow-2xs hover:bg-stone-50 transition-colors cursor-pointer group">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-stone-700">Сонсгол</span>
                </div>
              ...
              <div className="bg-white border border-stone-200/55 p-3.5 rounded-xl flex items-center justify-between shadow-2xs hover:bg-stone-50 transition-colors cursor-pointer group">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs font-bold text-stone-700">Унших</span>
                </div>
                <ChevronDown className="w-3.5 h-3.5 text-stone-400 -rotate-90" />
              </div>
            </div>
...
export function LeaderboardMockup() {
  const leadersList = [
    { rank: "🥇", name: "naranbadrakh", badge: "KING", xp: "+145", isSelf: true },
    ...
    <div className="w-full bg-white rounded-3xl overflow-hidden shadow-2xl border border-stone-200/60 text-stone-900 font-sans flex flex-col min-h-[500px]">
      ...
      <div className="border-b border-stone-100 px-4 py-3.5 flex items-center justify-between select-none bg-white shrink-0">
        <div className="flex items-center gap-2 group cursor-pointer">
          ...
          <span className="font-display font-extrabold text-sm tracking-tight text-orange-600">Mechi</span>
          <span className="bg-emerald-50 text-emerald-600 text-[9px] font-bold px-2 py-0.5 rounded-full border border-emerald-100">● PREMIUM ИДЭВХТЭЙ</span>
        </div>
      ...
      <div className="p-4 sm:p-8 bg-stone-50/50 flex-1 flex flex-col justify-center items-center select-none text-left w-full">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center justify-between mb-5 select-none w-full">
            <div className="flex items-center gap-2">
              <span className="text-xl sm:text-2xl font-light text-stone-400 hover:text-stone-700 cursor-pointer transition-colors">&lsaquo;</span>
              <h3 className="text-base sm:text-lg font-black text-stone-900 tracking-tight"> Лидерүүд</h3>
            </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="w-8 flex justify-center shrink-0">
                    {leader.rank === "🥇" ? (
                      <span className="w-6 h-6 rounded-full bg-amber-400 text-white font-extrabold text-[11px] flex items-center justify-center shadow-xs select-none">1</span>
                    ) : leader.rank === "🥈" ? (
                      <span className="w-6 h-6 rounded-full bg-stone-300 text-stone-850 font-extrabold text-[11px] flex items-center justify-center shadow-xs select-none">2</span>
                    ) : leader.rank === "🥉" ? (
                      <span className="w-6 h-6 rounded-full bg-orange-400 text-white font-extrabold text-[11px] flex items-center justify-center shadow-xs select-none">3</span>
                    ) : (
                      <span className="text-stone-400 font-mono font-bold text-xs">{leader.rank}</span>
                    )}
                  </div>
                  ...
                  <div>
                    <div className="flex items-center gap-1.5 flex-wrap">
                      <span className={`text-xs ${leader.isSelf ? "text-stone-950 font-extrabold" : "text-stone-600 font-semibold"}`}>
                        {leader.name}
                      </span>
                      {leader.badge && (
                    ...
                    <p className="text-[9px] text-stone-400 uppercase tracking-wider mt-0.5 font-sans font-semibold">долоо хоногийн xp</p>
                  </div>
                </div>

                {/* Score value right column */}
                <span className={`font-mono text-xs sm:text-sm font-bold shrink-0 ${
                  leader.isSelf ? "text-orange-600 font-extrabold" : "text-stone-500"
                }`}>
                  {leader.xp}
                </span>
              </div>
...
export default function MechiPresentation() {
  ...
  React.useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if (e.key === "ArrowDown" || e.key === "ArrowUp") {
        const sectionIds = ["hero", "problem", "features", "math", "hsk", "gamification", "portfolio", "pricing", "closing"];
  ...
  return (
    <div id="presentation-root" className="min-h-screen bg-stone-50 text-stone-900 overflow-x-hidden select-none selection:bg-orange-500 selection:text-white">
            ...
            >
              <div className="flex items-center gap-3 bg-white border border-stone-150 p-4 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col text-left">
                  <span className="text-[10px] uppercase font-mono tracking-wider text-stone-400">Туршилт</span>
                  <span className="font-bold text-stone-850 text-sm">1 өдрийн үнэгүй туршилт</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white border border-stone-150 p-4 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col text-left">
                  <span className="text-[10px] uppercase font-mono tracking-wider text-stone-400">Төлбөр</span>
                  <span className="font-bold text-stone-850 text-sm">Сард 15,000₮</span>
                </div>
              </div>
            </motion.div>
      ...
      {/* SECTION 3 - FEATURES */}
      <section id="features" className="min-h-screen flex items-center py-24 bg-white">
        <div className="max-w-7xl mx-auto w-full px-6 md:px-12 lg:px-20">
          <ScrollSection>
            <div className="mb-14">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
              ...
              <div className="bg-white border border-stone-200/60 p-8 rounded-3xl hover:border-orange-500/30 transition-all duration-300 shadow-sm relative group">
                ...
                <h3 className="text-xl sm:text-2xl font-extrabold font-display text-stone-900 mb-4 flex items-center gap-2">
                  <span>Үгийн сан</span>
                  <span className="text-xs bg-orange-100 text-orange-850 px-2 py-0.5 rounded font-mono font-bold">Flashcards</span>
                </h3>
      ...
      {/* SECTION 4 - THE MATH */}
      <section id="math" className="min-h-screen flex items-center py-24 bg-stone-50">
        <div className="max-w-7xl mx-auto w-full px-6 md:px-12 lg:px-20">
          <ScrollSection>
            ...
            <div className="relative mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative z-10">
                {[
                  ...
                  >
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center mb-4 shadow-xs ${
          ...
          <ScrollSection>
            ...
            <div className="rounded-2xl bg-orange-500/10 border border-orange-500/20 p-8 max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 text-left">
              ...
              <p className="text-lg sm:text-xl lg:text-xl font-bold font-display text-stone-200 leading-relaxed">
                HSK 3.0 garaхад Mechi автоматаар шинэчлэгдэнэ. Та нэмэлт төлбөргүйгээр шинэ контентыг ашиглах боломжтой.
              </p>
            </div>
          </ScrollSection>
        </div>
          ...
          <ScrollSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-stone-900/60 border border-stone-850 p-8 rounded-3xl flex flex-col items-center text-center shadow-lg hover:border-orange-500/20 transition-all">
                ...
                <h3 className="text-2xl sm:text-3xl font-bold font-display text-white mb-3">Rating</h3>
                <p className="text-stone-400 text-lg leading-relaxed max-w-xs">
      ...
      <section id="portfolio" className="bg-[#141414] text-white min-h-screen flex items-center py-24 relative overflow-hidden border-t border-stone-850/50">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 md:px-12 lg:px-20 relative z-10">
          <ScrollSection>
            <div className="text-center max-w-4xl mx-auto mb-16">
              <span className="text-xs uppercase font-mono tracking-widest text-orange-500 font-bold block mb-3">Сурсан чадварууд</span>
              ...
              <p className="text-lg md:text-xl text-stone-400 mt-5 max-w-2xl mx-auto leading-relaxed">
                9-р сараас хойш олж авсан мэдлэг, чадвараа нэгтгэн <span className="text-orange-500 font-extrabold font-display">Mechi</span> платформыг бүтээв.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {/* Card 1 - Software Development */}
              <div className="bg-stone-900/40 backdrop-blur-xs border border-stone-850/70 p-10 md:p-12 rounded-[2.5rem] hover:border-orange-500/30 transition-all duration-300 shadow-xl group hover:-translate-y-1">
                <div className="w-16 h-16 rounded-2xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center mb-8 shadow-sm group-hover:scale-105 transition-transform duration-250">
                  <Code2 className="w-8 h-8 text-orange-550" />
                </div>
                <h3 className="text-3xl sm:text-4xl font-black font-display text-white mb-2 tracking-tight">PROG & SOFTWARE</h3>
                <span className="text-sm font-mono font-bold tracking-widest text-orange-500 block">Програм хангамж</span>
                <p className="text-stone-300 text-base leading-relaxed mt-6">
                  Кодлох чадвараараа Mechi-ийн интерактив интерфэйс, XP & Streak болон лидерүүдийн самбарын логикийг бүрэн бүтээв.
                </p>
                <div className="flex flex-wrap gap-2 mt-8">
                  {["React", "TypeScript", "Tailwind CSS", "Local State"].map((tag, i) => (
                    <span key={i} className="text-xs uppercase font-mono font-bold px-3 py-1 bg-stone-800 text-stone-300 rounded-lg">
                      {tag}
                    </span>
                  ))}
                </div>
              ...
              <div className="bg-stone-900/40 backdrop-blur-xs border border-stone-850/70 p-10 md:p-12 rounded-[2.5rem] hover:border-orange-500/30 transition-all duration-300 shadow-xl group hover:-translate-y-1">
                <div className="w-16 h-16 rounded-2xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center mb-8 shadow-sm group-hover:scale-105 transition-transform duration-250">
                  <Palette className="w-8 h-8 text-orange-550" />
                </div>
                <h3 className="text-3xl sm:text-4xl font-black font-display text-white mb-2 tracking-tight">GRAPHIC DESIGN</h3>
                <span className="text-sm font-mono font-bold tracking-widest text-orange-500 block">График дизайн / UI/UX</span>
                <p className="text-stone-300 text-base leading-relaxed mt-6">
                  Хэрэглэгчийн аяллыг илүү сонирхолтой, ойлгомжтой болгох дулаан өнгө аястай UI/UX дизайнерын шийдлийг боловсруулав.
                </p>
                <div className="flex flex-wrap gap-2 mt-8">
                  {["Visual Brand", "Typography", "Colors", "UI Layout"].map((tag, i) => (
                    <span key={i} className="text-xs uppercase font-mono font-bold px-3 py-1 bg-stone-800 text-stone-300 rounded-lg">
                      {tag}
                    </span>
                  ))}
              ...
              <div className="bg-stone-900/40 backdrop-blur-xs border border-stone-850/70 p-10 md:p-12 rounded-[2.5rem] hover:border-orange-500/30 transition-all duration-300 shadow-xl group hover:-translate-y-1">
                <div className="w-16 h-16 rounded-2xl bg-orange-500/10 border border-orange-500/20 flex items-center justify-center mb-8 shadow-sm group-hover:scale-105 transition-transform duration-250">
                  <GraduationCap className="w-8 h-8 text-orange-550" />
                </div>
                <h3 className="text-3xl sm:text-4xl font-black font-display text-white mb-2 tracking-tight">CHINESE LESSONS</h3>
                <span className="text-sm font-mono font-bold tracking-widest text-orange-500 block">Хятад хэл сургалт</span>
                <p className="text-stone-300 text-base leading-relaxed mt-6">
                  Хэлний суурь болон дүрмийн мэдлэгтээ тулгуурлан хэрэглэгчдэд зориулсан монгол тайлбартай шинэлэг дасгалуудыг бэлтгэв.
                </p>
                <div className="flex flex-wrap gap-2 mt-8">
                  {["HSK 1-6", "Grammar Hub", "Listening Practise", "Flashcards"].map((tag, i) => (
                    <span key={i} className="text-xs uppercase font-mono font-bold px-3 py-1 bg-stone-800 text-stone-300 rounded-lg">
                      {tag}
                    </span>
                  ))}
            ...
            <div className="rounded-2xl bg-stone-900/50 border border-stone-800 p-8 max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 text-left">
              ...
              <p className="text-base sm:text-lg text-stone-300 leading-relaxed font-sans">
                Олж авсан мэдлэгээ бодит ажил болгож, сурагчдад хятад хэлийг сонирхолтойгоор сурахад туслах <span className="text-white font-extrabold">Mechi</span> аппликэйшнийг бүтээлээ.
              </p>
            </div>
          </ScrollSection>
        </div>
      ...
      {/* SECTION 7 - CLOSING */}
      <section id="closing" className="min-h-screen flex flex-col justify-center py-24 bg-[#1a1a1a] text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto w-full px-6 md:px-12 lg:px-20 relative z-10">
          <ScrollSection>
            <div className="text-center max-w-4xl mx-auto mb-12">
              <motion.h2 
                className="text-5xl sm:text-7xl md:text-8xl font-black font-display tracking-tight text-white mb-6 leading-none"
              >
                Өнөөдөр эхэл.
              </motion.h2>
              ...
              <p className="text-stone-400 text-lg sm:text-xl font-sans max-w-xl mx-auto">
                Утсаараа QR кодыг уншуулан хятад хэл сурах аяллаа шууд эхлүүлээрэй
              </p>
            </div>

            {/* Stunning QR Code displaying the specified mechi-xi.vercel.app domain */}
            <div className="flex justify-center items-center">
              <div id="qr-container" className="bg-white p-8 rounded-4xl shadow-2xl shadow-orange-500/10 border-2 border-orange-500 flex flex-col items-center gap-4 hover:scale-[1.03] transition-transform duration-300 max-w-xs">
                ...
                <div className="text-center font-mono text-stone-900">
                  <p className="text-sm font-bold tracking-tight uppercase text-stone-500">Албан ёсны сайт</p>
                  <p className="text-base font-extrabold text-orange-600 mt-0.5">mechi-xi.vercel.app</p>
                </div>
              </div>
            </div>
          </ScrollSection>
