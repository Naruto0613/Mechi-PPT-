  ...
  const points = [
    {
      ...
      title: "Хятад хэлний орчин үеийн платформ",
      description:
        "Уламжлалт хуурай заавраас татгалзаж, орчин үеийн цахим шийдлээр харах тусам тогтоох шинэлэг орчныг бүрдүүлнэ.",
    },
    {
      icon: <Layers className="w-5 h-5 text-brand-orange" />,
      title: "Анхлан суралцагчдад зориулсан цэгцтэй систем",
      description:
        "Ханзыг танин мэдэхүйн язгуур бүтцээр нь ангилж, анхнаасаа зөв, хялбар сурах суурийг тавина.",
    },
    {
      icon: <Volume2 className="w-5 h-5 text-brand-orange" />,
      title: "Практикт суурилсан үр дүнтэй сургалт",
      description:
        "Өдөр тутмын амьдралд шууд хэрэглэгдэх хамгийн чухал үг хэллэг, өгүүлбэрийн бүтцийг заана.",
    },
    {
      icon: <ShieldCheck className="w-5 h-5 text-brand-orange" />,
      title: "Монгол сурагчдад зориулсан арга зүй",
      description:
        "Хятад хэлний өргөлт, дуудлагыг монгол хүний авиа зүйн онцлогт тохируулан, хамгийн ойлгомжтойгоор заана.",
    },
  ];
      ...
      <div className="flex-1 max-w-6xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center z-10 mt-6 lg:mt-0">
        ...
        <div className="lg:col-span-5 flex flex-col justify-center order-1 lg:order-2">
          ...
          <p className="text-brand-charcoal/70 text-sm md:text-base font-light leading-relaxed mb-6">
            Хятад хэлийг логик, харааны болон байгалийн холбоос бүхий системтэй
            болгох соёлын гүүрийг бүтээв.
          </p>
          ...
          <div className="flex items-center gap-2 text-[#A5A5A5] font-mono text-xs tracking-wider font-semibold">
            <span>● ОРЧИН ҮЕИЙН СИСТЕМТ АРГА ЗҮЙ</span>
            <span className="text-[#EAE7E2]">|</span>
            <span>● МОНГОЛ СУРАГЧДАД ЗОРИУЛСАН ХӨТӨЛБӨР</span>
          </div>
        </div>
      </div>
